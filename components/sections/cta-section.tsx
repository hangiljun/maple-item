      ...
      <div className="max-w-4xl mx-auto px-4">
        <div className="relative overflow-hidden bg-gradient-to-r from-[#FFB800] via-[#FF9500] to-[#FFB800] rounded-3xl p-12 text-center text-white shadow-2xl">
          ...
          <div className="relative z-10">
            <Gift className="mx-auto mb-6 text-white" size={64} />
            ...
            <a
              ...
              className="inline-flex items-center gap-3 bg-white text-[#FF9500] px-12 py-5 rounded-full font-black text-2xl hover:bg-[#FFF8ED] transition shadow-2xl transform hover:scale-105"
            >
              <MessageCircle size={32} /> 💰 지금 바로 팔러가기
            </a>
