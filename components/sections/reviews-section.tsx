    ...
    <section className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-12">
          <span className="text-[#197DAC] font-bold text-sm uppercase tracking-wider">Reviews</span>
          ...
          {reviews.map((review) => (
            ...
            >
              ...
              <div className="flex items-center gap-2 mb-3">
                <div className="flex gap-0.5 text-[#2C9FD6]">
                  {[...Array(5)].map((_, i) => (
        ...
        <div className="text-center">
          <Link
            href="/reviews"
            className="inline-flex items-center gap-2 text-[#197DAC] font-bold hover:text-[#126C96] transition"
          >
            후기 전체보기 →
          </Link>
        </div>
